\makeprojects{
    ...
    {
        \item Designed and prototyped a responsive personal portfolio website using JavaScript and React.
    ...
    {https://github.com/alfieatkinson/library-management-system}
    {
        ...
        \item Implemented 40+ unit tests using Catch2 to facilitate continuous integration and Test-Driven Development.
